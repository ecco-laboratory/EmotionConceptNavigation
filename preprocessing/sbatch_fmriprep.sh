...
STUDY_DIR="/home/data/eccolab/MNS/"
BIDS_DIR="${STUDY_DIR}data/fmri/nifti"
DERIVS_DIR="derivatives/fmriprep-25.0.0"
...
SINGULARITY_CMD="singularity run --cleanenv --bind ${BIDS_DIR}:/data --bind /home/data/shared/SingularityImages/:/fslicensepath --bind ${TEMPLATEFLOW_HOST_HOME}:${SINGULARITYENV_TEMPLATEFLOW_HOME}  --bind ${STUDY_DIR}/ignore/tmp:/work  /home/data/shared/SingularityImages/fmriprep-25.0.0.simg"

# echo Current slurm array task ID: $SLURM_ARRAY_TASK_ID
# Parse the participants.tsv file and extract one subject ID from the line corresponding to this SLURM task.
# subject=$( sed -n -E "$((${SLURM_ARRAY_TASK_ID} + 1))s/sub-(\S*)\>.*/\1/gp" ${BIDS_DIR}/participants.tsv )
printf -v subject "sub-%04d" $SLURM_ARRAY_TASK_ID #printf -v subject "sub-%04d" $SLURM_ARRAY_TASK_ID
