...
LOG_FILE_PATH="/home/yma/log/sbatch_fmriprep.sh-${JOB_ID_LOG}.err"
while true
do
    ...
    if [ $GREP_LENGTH -gt 0 ]; then 
        ...
        NEW_SBATCH_OUT=$(sbatch --array=$ARRAY_ID /home/data/eccolab/MNS/preprocessing/sbatch_fmriprep.sh)
        NEW_JOB_ID=$(echo $NEW_SBATCH_OUT | awk '{print $4}')_${ARRAY_ID}
        sbatch /home/data/eccolab/MNS/preprocessing/monitor_fmriprep.sh $NEW_JOB_ID
        exit
    fi
